...
public:
  ...
  //
  // passed nodes, performs a lookup on each node and 
  // retrieves the node's latitude and longitude
  // returns the average latitude and longitude as a pair <double, double>
  //
